...
def generate2(
        ...
        tokenizer,
        tokens=None,
        prompt=None, # check later to see if this has any effect
        embed=None,
        entry_count=1,
...
def image():
    ...
    beamsearch = request.form['beamsearch']

    use_beam_search = beamsearch #@param {type:"boolean"}  
    ...
    return jsonify({"text": generated_text_prefix})
